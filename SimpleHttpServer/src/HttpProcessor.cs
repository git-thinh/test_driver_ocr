...
namespace SimpleHttpServer
{
    public class HttpProcessor
    {
        ...
        public void HandleClient(TcpClient tcpClient, IApp app)
        {
                Stream inputStream = GetInputStream(tcpClient);
                Stream outputStream = GetOutputStream(tcpClient);
                HttpRequest request = GetRequest(inputStream, outputStream, app);

                // route and handle the request...
                HttpResponse response = RouteRequest(inputStream, outputStream, request, app);      
        ...
        private HttpRequest GetRequest(Stream inputStream, Stream outputStream, IApp app)
        {
            //Read Request Line
